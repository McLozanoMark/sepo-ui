(function(){
  ...
  function resetForm(){
    applyForm({ desc:'', formula:'', ord:factors().length + 1, dec:2, dep:'', outputTypes:['puntaje'], generateByQuestion:false, expectedEnabled:false, expectedMin:'', expectedMax:'' });
      ...
      return `
        <div class="sepo-factor-item" data-index="${group.indexes[0]}">
          <div class="sepo-factor-item-main">
            ...
            <div class="sepo-factor-meta-line">${typeBadges}${expected}${auto}</div>
          </div>
  ...
  function renderSummary(){
    ...
    if (thead) thead.innerHTML = `<tr><th>Factor</th><th>Descripción</th><th>Vinculación</th><th>Valor esperado</th><th>Asignaciones</th><th>Acumulado</th><th>Detalle</th></tr>`;
